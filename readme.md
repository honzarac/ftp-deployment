...
are compressed using the clean-css and `.js` are minified by UglifyJS (both via Node.js tool).
...
If you want to use minification, install [Node.js](https://nodejs.org/en/) and [UglifyJS](https://www.npmjs.com/package/uglify-js)
